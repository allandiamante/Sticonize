...
const dict = {
  pt: {
    ...
    vec: {
      ...
      copied: 'Copiado',
      editHint: 'Clique numa forma para trocar a cor ou apagar · ctrl+clique marca várias · Del apaga · role o mouse para dar zoom',
  ...
  en: {
    ...
    vec: {
      ...
      copy: 'Copy SVG code',
      copied: 'Copied',
      editHint: 'Click a shape to recolor or delete it · ctrl+click to pick more than one · Del deletes · scroll to zoom in',
  ...
  nl: {
    ...
    vec: {
      ...
      copied: 'Gekopieerd',
      editHint: 'Klik op een vorm om hem te verkleuren of te wissen · ctrl+klik kiest er meerdere · Del wist · scroll om in te zoomen',
