...
server {
  ...
  # $uri.html: /vectorize is built as its own vectorize.html, and it must be served without a
  # redirect to a /vectorize/ form. Anything else the app routes falls through to index.html.
